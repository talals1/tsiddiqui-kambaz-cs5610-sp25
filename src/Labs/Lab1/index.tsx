    ...
    return (
      <div id="wd-lab1">
        ...
        <div id="wd-lists">
          ...
          My favorite recipe: Fettuccine Alfredo
          <br></br>
          https://www.allrecipes.com/recipe/23431/to-die-for-fettuccine-alfredo/
          <ol id="wd-your-favorite-recipe">
            <li>Cook pasta for 8-10 minutes. Al dente.</li>
            <li>Melt butter with salt, pepper, and garlic in a large saucepan.</li>
            <li>Add parmesean and romano cheese and stir until thick.</li>
            <li>Toss pasta in sauce and serve!</li>
          </ol>
        ...
        <div id="wd-tables">
          ...
          <table border={1} width="100%">
            ...
            <tbody>
              ...
              <tr>
                <td>Q10</td>
                <td>Developing Avionics Software with Lisp and Scheme</td>
                <td>3/10/21</td>
                <td>92</td>
              </tr>
            </tbody>
        ...
        <div id="wd-forms">
          ...
          Here is the <a href="https://www.lipsum.com" id="wd-github">GitHub repository</a> for this code.<br/>
        </div>
      </div>
    );
  }
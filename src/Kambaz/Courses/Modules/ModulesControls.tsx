  ...
  return (
    <div id="wd-modules-controls" className="text-nowrap">
      ...
      <Dropdown className="float-end me-2">
        <Dropdown.Toggle variant="secondary" size="lg" id="wd-publish-all-btn" disabled={currentUser.role === "STUDENT"}>
        ...
        <Dropdown.Menu>
          ...
          {/* DONE Create two more items with IDs wd-unpublish-all-modules-and-items and wd-unpublish-modules-only with
